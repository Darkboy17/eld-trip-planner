...
SECRET_KEY = "django-insecure-%!(a%kd+aws(s(k^!1si87z8s)q3*6-mnw4+88(p#+o7n%0#kw"
...
# CORS middleware must run early so local Vite requests can reach the API in development.
MIDDLEWARE = [
...
# Frontend development origin allowed to call the Django API.
CORS_ALLOW_ALL_ORIGINS = True

# The API is JSON-only for this project; browsable renderer output is not needed.
REST_FRAMEWORK = {
